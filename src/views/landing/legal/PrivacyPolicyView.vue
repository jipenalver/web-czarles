            ...
            <div class="privacy-policy-content">
              ...
              <section class="mb-6">
                ...
                <ul :class="[listTextClass, 'mb-4']">
                  <li>
                    <strong>Phone Number:</strong> Used for authentication and account creation
                  </li>
                  <li>
                    <strong>Employee Information:</strong> Name, employee ID, and job-related
                    details as provided by your employer
                  </li>
                  <li>
                    <strong>Location Data:</strong> Real-time GPS coordinates when clocking in/out
                    for attendance verification
                  </li>
                  <li>
                    <strong>Images:</strong> Photos captured during attendance check-in/check-out
                    for verification purposes
                  </li>
                  <li>
                    <strong>Attendance Records:</strong> Clock-in/out times, overtime hours, and
                    attendance status
                  </li>
                </ul>
                ...
                <ul :class="[listTextClass, 'mb-4']">
                  ...
                  <li>
                    <strong>Usage Data:</strong> App usage patterns, features accessed, and
                    performance metrics
                  </li>
                  <li>
                    <strong>Location Services:</strong> GPS coordinates and location accuracy data
                  </li>
                  <li>
                    <strong>Camera Access:</strong> Image capture capabilities for attendance
                    verification
                  </li>
                </ul>
                ...
                <ul :class="[listTextClass, 'mb-4']">
                  <li>
                    <strong>Network Information:</strong> Internet connectivity status for
                    offline/online synchronization
                  </li>
                  <li>
                    <strong>Device Storage:</strong> Local storage of attendance data for offline
                    functionality
                  </li>
                  <li>
                    <strong>Security Data:</strong> Fake location detection and security
              ...
              <section class="mb-6">
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    <strong>Location Verification:</strong> Ensure attendance is recorded from
                    authorized work locations
                  </li>
                  <li>
                    <strong>Authentication:</strong> Verify your identity through phone number
                    verification
                  </li>
                  <li>
                    <strong>Offline Capabilities:</strong> Store attendance data locally when
                    internet is unavailable
                  </li>
                  <li>
                    <strong>Automatic Synchronization:</strong> Sync local data with servers when
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    <strong>Data Integrity:</strong> Ensure accuracy and reliability of attendance
                    records
                  </li>
                  <li>
                    <strong>Employer Compliance:</strong> Provide accurate attendance data to your
                    employer
                  </li>
                </ul>
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    <strong>Technical Support:</strong> Provide customer support and troubleshooting
                  </li>
                  <li>
                    <strong>Feature Development:</strong> Develop new features based on usage
                    patterns
                  </li>
                </ul>
              </section>
              ...
              <section class="mb-6">
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    Attendance records are shared with authorized personnel for payroll and HR
                    purposes
                  </li>
                ...
                <ul class="mb-4">
                  <li>
                    <strong>Supabase:</strong> For secure data storage, authentication, and
                    real-time synchronization
                  </li>
                  <li>
                    <strong>Device Services:</strong> Camera and GPS services provided by your
              ...
              <section class="mb-6">
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    <strong>Secure Authentication:</strong> Phone number-based authentication with
                    secure tokens
                  </li>
                  <li>
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    <strong>Local Storage:</strong> Minimal data cached locally on your device for
                    offline functionality
                  </li>
                  <li>
                    <strong>Backup Systems:</strong> Regular backups ensure data availability and
                    recovery
                  </li>
                </ul>
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    <strong>Post-Employment:</strong> Attendance records may be retained as required
                    by law or company policy
                  </li>
                  <li>
                    <strong>Account Deletion:</strong> You may request account deletion subject to
              ...
              <section class="mb-6">
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    <strong>Data Correction:</strong> Request correction of inaccurate information
                  </li>
                  <li>
                    <strong>Data Deletion:</strong> Request deletion of your data (subject to legal
                    requirements)
                  </li>
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    <strong>Camera Access:</strong> You can deny camera access, but attendance
                    verification may be limited
                  </li>
                  <li>
                    <strong>Notifications:</strong> Control app notifications through device
                    settings
                  </li>
                </ul>
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    <strong>Marketing Communications:</strong> We do not send marketing
                    communications through this app
                  </li>
                </ul>
              </section>
              ...
              <section class="mb-6">
                ...
                <p class="mb-3">
                  If you are located in the European Union, our legal basis for processing your
                  personal information includes:
                </p>
                <ul class="mb-4">
                  <li>
                    <strong>Legitimate Interest:</strong> For attendance tracking and fraud
                    prevention
                  </li>
                  ...
                  <li>
                    <strong>Consent:</strong> Where explicitly provided for specific processing
                    activities
                  </li>
                </ul>
              </section>
              ...
              <section class="mb-6">
                ...
                <p class="mb-4">We do not sell personal information to third parties.</p>
              </section>
              ...
              <div class="text-center">
                ...
                <p class="text-body-2">
                  By using the Czarles Employee Attendance App, you acknowledge that you have read,
