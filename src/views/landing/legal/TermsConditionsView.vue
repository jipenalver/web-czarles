          ...
          <v-card :class="[heroComputed.cardPadding, 'ma-2 ma-md-4']" outlined>
            <div class="terms-conditions-content">
              ...
              <section class="mb-6">
                ...
                <ul :class="[listTextClass, 'mb-4']">
                  <li>
                    Users must provide a valid phone number for account registration and
                    authentication
                  </li>
                  <li>
              ...
              <section class="mb-6">
                ...
                <ul :class="[listTextClass, 'mb-4']">
                  <li>
                    The App requires access to your device's GPS location for attendance
                    verification
                  </li>
                  <li>
                    Location data is collected only during attendance check-in/check-out processes
                  </li>
                  <li>The App includes fake location detection to ensure data integrity</li>
                  <li>
                    By using the App, you consent to location data collection as described in our
                    Privacy Policy
                  </li>
                </ul>
              </section>
              ...
              <section class="mb-6">
                ...
                <ul :class="[listTextClass, 'mb-4']">
                  ...
                  <li>
                    You grant us the right to use captured images for attendance verification and
                    record-keeping
                  </li>
                </ul>
              </section>
              ...
              <section class="mb-6">
                ...
                <ul :class="[listTextClass, 'mb-4']">
                  <li>
                    The App can function offline and will sync data when connectivity is restored
                  </li>
                  <li>You are responsible for ensuring data accuracy during offline use</li>
                  <li>
                    Offline data will be automatically synchronized when internet connection is
                    available
                  </li>
                </ul>
              </section>
              ...
              <section class="mb-6">
                ...
                <ul :class="[listTextClass, 'mb-4']">
                  ...
                  <li>
                    Any attempts to manipulate attendance data may result in account suspension
                  </li>
                  <li>
                    The App implements security measures to detect and prevent fraudulent activity
                  </li>
                </ul>
              </section>
              ...
              <section class="mb-6">
                ...
                <ul class="mb-4">
                  <li>
                    The App and its content are owned by C'Zarles Construction and Supplies and
              ...
              <section class="mb-6">
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    Our total liability shall not exceed the amount paid for using the App (if any)
                  </li>
                  <li>
                    We are not responsible for data loss due to device malfunction or user error
                  </li>
                </ul>
              </section>
              ...
              <section class="mb-6">
                ...
                <ul class="mb-4">
                  ...
                  <li>
                    You are responsible for ensuring your use complies with employment regulations
                  </li>
              ...
              <section class="mb-6">
                ...
                <ul class="mb-4">
                  <li>
                    Attendance records are retained as required by employment law and company policy
                  </li>
                  <li>
                    You may request account deletion, subject to legal and business requirements
                  </li>
                  <li>
              ...
              <div class="text-center">
                ...
                <p class="text-body-2">
                  By using the Czarles Mobile App, you acknowledge that you have read, understood,
