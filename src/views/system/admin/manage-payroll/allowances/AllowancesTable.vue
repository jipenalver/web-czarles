  ...
  <v-card>
    <v-card-text>
      ...
      <v-data-table-server
        ...
        :items="allowancesStore.allowancesTable"
        :items-length="allowancesStore.allowancesTableTotal"
        ...
        <template #item.actions="{ item }">
          <div class="d-flex align-center" :class="smAndDown ? 'justify-end' : 'justify-center'">
            <v-btn variant="text" density="comfortable" @click="onUpdate(item)" icon>
              ...
              <v-tooltip activator="parent" location="top">Edit Allowance</v-tooltip>
            </v-btn>

            <v-btn variant="text" density="comfortable" @click="onDelete(item.id)" icon>
              <v-icon icon="mdi-trash-can" color="secondary"></v-icon>
              <v-tooltip activator="parent" location="top">Delete Allowance</v-tooltip>
            </v-btn>
          </div>
        </template>
      </v-data-table-server>
