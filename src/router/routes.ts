...
import TrippingView from '@/views/system/admin/manage-payroll/TrippingView.vue'
...
export const routes = [
  ...
  // Payroll
  {
    path: '/hrms/payroll/trippings',
    name: 'hrms-payroll-trippings',
    component: TrippingView,
    meta: { requiresAuth: true },
  },
  {
